...
const emailCopy: Record<EmailLocale, EmailCopy> = {
  ko: {
    htmlLang: "ko",
    verification: {
      subject: "[969] 이메일 인증 안내",
      heading: "969 이메일 인증",
      greeting: "안녕하세요.",
      body: "969 회원가입을 계속하려면 아래 버튼을 눌러 이메일 주소를 인증해 주세요.",
      button: "이메일 인증 완료하기",
      notice: "이 링크는 15분 동안만 유효합니다. 본인이 요청하지 않았다면 이 이메일을 무시해 주세요.",
    },
    passwordReset: {
      subject: "[969] 비밀번호 재설정 안내",
      heading: "969 비밀번호 재설정",
  ...
  en: {
    htmlLang: "en",
    verification: {
      subject: "[969] Verify your email address",
      heading: "Verify your 969 email",
      greeting: "Hello,",
      body: "To continue creating your 969 account, please verify your email address using the button below.",
      button: "Verify email address",
      notice: "This link expires in 15 minutes. If you did not request this, you can safely ignore this email.",
    },
    passwordReset: {
      subject: "[969] Reset your password",
      heading: "Reset your 969 password",
  ...
  zh: {
    ...
    verification: {
      ...
      heading: "969 邮箱验证",
      greeting: "您好，",
      body: "如需继续注册 969，请点击下方按钮验证您的邮箱地址。",
      button: "完成邮箱验证",
